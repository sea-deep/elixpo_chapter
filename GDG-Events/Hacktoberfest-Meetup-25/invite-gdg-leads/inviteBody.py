def prepareBody():
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                <h2><span>You have been invited</span> as a guest to the GDG Session of Hacktoberfest x Google Study Jams 🤝</h2>

                <p>Dear <b>Samrat Talukdar</b>,</p>
                <p>
                    We are thrilled to invite you to be a <b>guest</b> for our upcoming 
                    <b>Hacktoberfest x GDG Study Jams Session</b> on <b>13th October 2025</b>. 
                    Your expertise as a GDG On Campus Lead for NiT makes you an ideal guest 
                ...
                <div class="highlight">
                    <p style="margin: 0; font-weight: 600;">
                        📅 <b>Date & Time:</b> 13th October 2025, 10:00 AM - 12:00 PM<br>
                        📍 <b>Location:</b> Room 1009, JIS University Campus <br>
                        🎯 <b>Role:</b> Guest<br>
                </div>
                ...
                <div style="text-align:center; margin: 25px 0;">
                    <a href="https://gdg.community.dev/e/mmsdux/" 
                ...
                <p style="margin: 20px 0; 
                    ...
                    border-radius: 6px; 
                    line-height: 1.6;">
                    🌟 Once again, thank you <b>Samrat Talukdar</b> 
                    for joining us at GDG JIS University. 
