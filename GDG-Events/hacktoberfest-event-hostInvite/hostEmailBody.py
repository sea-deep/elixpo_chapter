def prepareBody(name):
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                <h2><span>You have been invited. </span> for hosting the GDG Session of Hacktoberfest x Google Study Jams 🤝</h2>

                <p>Dear <b>Abiroy Karmakar</b>,</p>
                <p>
                ...
                <div class="highlight">
                    <p style="margin: 0; font-weight: 600;">
                        ...
                        📍 <b>Location:</b> JIS University Campus / Offline <br>
                        🎯 <b>Role:</b> Host <br>
                </div>
                ...
                <p style="margin: 20px 0; 
                    ...
                    border-radius: 6px; 
                    line-height: 1.6;">
                    🌟 Once again, thank you <b>Abiroy Karmakar</b> 
