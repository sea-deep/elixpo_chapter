...
async function generateAsciiArt() {
    ...
    - The art must fill a 12x5 grid (12 columns and 9 rows) completely without extra spaces.
    ...
    // Simulating API call
      try {
        ...
        displayAsciiArt(asciiArt, prompt);
      } catch (error) {
...
function displayAsciiArt(art, prompt) {
    document.getElementById("asciiArtZone").textContent = art;
    document.getElementById("promptTextBox").textContent = prompt || "Waiting for prompt...";
}
